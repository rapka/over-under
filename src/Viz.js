...
class Viz extends React.Component {
  ...
  componentDidMount() {
    ...
    function draw() {
      ...
      WIDTH = window.innerWidth;
      H = (H + 0.5) % 360;
      console.log('friomm', HEIGHT, WIDTH, canvasCtx);
      ...
      canvasCtx.strokeStyle = `rgba(${rgb[0]}, ${rgb[1]}, ${rgb[2]}, 0.55)`;
      canvasCtx.beginPath();
      ...
      canvasCtx.strokeStyle = `rgb(${rgb[0]}, ${rgb[1]}, ${rgb[2]}, 0.55)`;
      canvasCtx.beginPath();
      x = 0;
